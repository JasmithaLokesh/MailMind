    ...
    <div className={`${theme==="dark"?"bg-[#0F172A] text-white":"bg-white text-[#0F172A]"} min-h-screen flex`}>
      ...
      <main className="flex-1 p-8 lg:p-10 transition-all duration-300 h-screen overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-4xl font-bold text-orange-500">Spam Mails</h1>
          <div className="text-slate-500 font-medium">{total} total spam emails</div>
        </div>
              ...
              {emails.map((email) => (
                ...
                >
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-slate-600 dark:text-slate-400 mb-2 truncate max-w-2xl">
                      {email.sender}
                    </p>
                    <p className="text-sm text-slate-500 dark:text-slate-500 truncate max-w-3xl">
